...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="card">
    <div class="card-body">
      <h4 class="mb-3"><i class="ri-add-line me-2"></i>Create Payslip</h4>
      ...
      <form method="post" action="{{ route('payslips.store') }}">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-4">
            ...
            <input type="number" name="month" class="form-control @error('month') is-invalid @enderror" placeholder="01-12" min="1" max="12" value="{{ old('month') }}">
            @error('month') <span class="invalid-feedback">{{ $message }}</span> @enderror
          </div>
          <div class="col-md-4">
            <label class="form-label">Year <span class="text-danger">*</span></label>
            <input type="number" name="year" class="form-control @error('year') is-invalid @enderror" placeholder="YYYY" value="{{ old('year') }}">
          ...
          <div class="col-md-6">
            ...
            <input type="number" name="gross_salary" class="form-control @error('gross_salary') is-invalid @enderror" placeholder="0.00" step="0.01" value="{{ old('gross_salary') }}">
          ...
          <div class="col-md-6">
            ...
            <input type="number" name="deductions" class="form-control @error('deductions') is-invalid @enderror" placeholder="0.00" step="0.01" value="{{ old('deductions') }}">
        ...
        <div class="d-flex justify-content-end gap-2 mt-4">
          ...
          <button class="btn btn-primary" type="submit">Create Payslip</button>
        </div>
      </form>
    </div>
  </div>
