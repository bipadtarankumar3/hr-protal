			...
			<form>
				<div class="row g-3">
					<div class="col-md-4">
						...
						<input class="form-control" placeholder="e.g. HR Manager">
					</div>
					<div class="col-md-2">
						<label class="form-label">Level</label>
						<select class="form-select"><option>Intern</option><option>Associate</option><option>Senior</option><option>Manager</option><option>CXO</option></select>
					</div>
					<div class="col-md-3">
						<label class="form-label">Department</label>
						<input class="form-control" placeholder="e.g. HR">
					</div>
					<div class="col-md-3">
						<label class="form-label">Reports To</label>
						<input class="form-control" placeholder="e.g. CHRO">
					</div>
				</div>
